...
def pre_check() -> bool:
    ...
    util.conditional_download(download_directory_path, ['https://huggingface.co/akhaliq/GPEN-BFR-512/resolve/e6e4f31c275697a77fb0ee3e0a273c3313378dfe/GPEN-BFR-512.pth?download=true'])
